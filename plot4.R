...
par(mfrow = c(2, 2)) 
##1
plot(hpc_data_rg$Datetime, hpc_data_rg$Global_active_power, type="l", xlab="", ylab="Global Active Power", cex=0.2)
##2
plot(hpc_data_rg$Datetime, hpc_data_rg$Voltage, type="l", xlab="datetime", ylab="Voltage")
##3
...
##4
plot(hpc_data_rg$Datetime, hpc_data_rg$Global_reactive_power, type="l", xlab="datetime", ylab="Global_reactive_power")
##Close device
dev.off()